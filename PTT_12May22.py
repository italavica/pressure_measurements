...
from matplotlib.pyplot import plot, legend, show, grid, figure, savefig, title, xlabel, ylabel
import extract_data_12May22

s1,s2,s3,s4,s5,s6,s7,s8,s9,s10=extract_data_12May22.extract_data_10ml()


def PTT_v1(s1,s2,s3,s4,s5,s6,s7,s8,s9,s10):

    PS1_1=s1['Voltage_1'][0:10000]
    PS1_2=s2['Voltage_1'][0:11000]
    PS1_3=s3['Voltage_1'][0:11000]
    PS1_4=s4['Voltage_1'][0:10400]
    PS1_5=s5['Voltage_1'][0:11000]
    PS1_6=s6['Voltage_1'][0:10700]
    PS1_7=s7['Voltage_1'][0:6000]
    PS1_8=s8['Voltage_1'][0:10200]
    PS1_9=s9['Voltage_1'][0:11000]
    PS1_10=s10['Voltage_1'][0:11000]

    PS2_1=s1['Voltage_2'][0:10000]
    PS2_2=s2['Voltage_2'][0:11000]
    PS2_3=s3['Voltage_2'][0:11000]
    PS2_4=s4['Voltage_2'][0:10400]
    PS2_5=s5['Voltage_2'][0:11000]
    PS2_6=s6['Voltage_2'][0:10700]
    PS2_7=s7['Voltage_2'][0:6000]
    PS2_8=s8['Voltage_2'][0:10200]
    ...
    PTT_7= loc_PS2_7[0:6]-loc_PS1_7[0:6]
    ...
    # figure(figsize=(10,5))
    # plot(t,PS1_filtered_1, 'g', linewidth=1.75,label='PS1')
    # #plot(t,PS1_7, 'g', linewidth=1.75,label='PS1')
    # plot(loc_PS1_1/fs,PS1_filtered_1[loc_PS1_1], 'r*', linewidth=1.75)
    # plot(t,PS2_filtered_1, 'b', linewidth=1.75,label='PS2')
    # #plot(t,PS2_7, 'b', linewidth=1.75,label='PS2')
    # plot(loc_PS2_1/fs,PS2_filtered_1[loc_PS2_1], 'r*', linewidth=1.75)
    # legend()
    ...
    return mPTT,sPTT
print('10 ml')
s1_10ml,s2_10ml,s3_10ml,s4_10ml,s5_10ml,s6_10ml,s7_10ml,s8_10ml,s9_10ml,s10_10ml=extract_data_12May22.extract_data_10ml()
mPTT_10ml,sPTT_10ml=PTT_v1(s1_10ml,s2_10ml,s3_10ml,s4_10ml,s5_10ml,s6_10ml,s7_10ml,s8_10ml,s9_10ml,s10_10ml)
print(' 15 ml')
s1_15ml,s2_15ml,s3_15ml,s4_15ml,s5_15ml,s6_15ml,s7_15ml,s8_15ml,s9_15ml,s10_15ml=extract_data_12May22.extract_data_15ml()
mPTT_15ml,sPTT_15ml=PTT_v1(s1_15ml,s2_15ml,s3_15ml,s4_15ml,s5_15ml,s6_15ml,s7_15ml,s8_15ml,s9_15ml,s10_15ml)
print('/n 20 ml')
s1_20ml,s2_20ml,s3_20ml,s4_20ml,s5_20ml,s6_20ml,s7_20ml,s8_20ml,s9_20ml,s10_20ml=extract_data_12May22.extract_data_20ml()
mPTT_20ml,sPTT_20ml=PTT_v1(s1_20ml,s2_20ml,s3_20ml,s4_20ml,s5_20ml,s6_20ml,s7_20ml,s8_20ml,s9_20ml,s10_20ml)
print('/n 25 ml')
s1_25ml,s2_25ml,s3_25ml,s4_25ml,s5_25ml,s6_25ml,s7_25ml,s8_25ml,s9_25ml,s10_25ml=extract_data_12May22.extract_data_25ml()
mPTT_25ml,sPTT_25ml=PTT_v1(s1_25ml,s2_25ml,s3_25ml,s4_25ml,s5_25ml,s6_25ml,s7_25ml,s8_25ml,s9_25ml,s10_25ml)
print('/n 30 ml')
s1_30ml,s2_30ml,s3_30ml,s4_30ml,s5_30ml,s6_30ml,s7_30ml,s8_30ml,s9_30ml,s10_30ml=extract_data_12May22.extract_data_30ml()
mPTT_30ml,sPTT_30ml=PTT_v1(s1_30ml,s2_30ml,s3_30ml,s4_30ml,s5_30ml,s6_30ml,s7_30ml,s8_30ml,s9_30ml,s10_30ml)
print('/n 35 ml')
s1_35ml,s2_35ml,s3_35ml,s4_35ml,s5_35ml,s6_35ml,s7_35ml,s8_35ml,s9_35ml,s10_35ml=extract_data_12May22.extract_data_35ml()
mPTT_35ml,sPTT_35ml=PTT_v1(s1_35ml,s2_35ml,s3_35ml,s4_35ml,s5_35ml,s6_35ml,s7_35ml,s8_35ml,s9_35ml,s10_35ml)
print('/n 40 ml')
s1_40ml,s2_40ml,s3_40ml,s4_40ml,s5_40ml,s6_40ml,s7_40ml,s8_40ml,s9_40ml,s10_40ml=extract_data_12May22.extract_data_40ml()
mPTT_40ml,sPTT_40ml=PTT_v1(s1_40ml,s2_40ml,s3_40ml,s4_40ml,s5_40ml,s6_40ml,s7_40ml,s8_40ml,s9_40ml,s10_40ml)
print('/n 45 ml')
s1_45ml,s2_45ml,s3_45ml,s4_45ml,s5_45ml,s6_45ml,s7_45ml,s8_45ml,s9_45ml,s10_45ml=extract_data_12May22.extract_data_45ml()
mPTT_45ml,sPTT_45ml=PTT_v1(s1_45ml,s2_45ml,s3_45ml,s4_45ml,s5_45ml,s6_45ml,s7_45ml,s8_45ml,s9_45ml,s10_45ml)
print('/n 50 ml')
s1_50ml,s2_50ml,s3_50ml,s4_50ml,s5_50ml,s6_50ml,s7_50ml,s8_50ml,s9_50ml,s10_50ml=extract_data_12May22.extract_data_50ml()
mPTT_50ml,sPTT_50ml=PTT_v1(s1_50ml,s2_50ml,s3_50ml,s4_50ml,s5_50ml,s6_50ml,s7_50ml,s8_50ml,s9_50ml,s10_50ml)
# print('/n 55 ml')
# s1_55ml,s2_55ml,s3_55ml,s4_55ml,s5_55ml,s6_55ml,s7_55ml,s8_55ml,s9_55ml,s10_55ml=extract_data_12May22.extract_data_55ml()
# mPTT_55ml,sPTT_55ml=PTT_v1(s1_55ml,s2_55ml,s3_55ml,s4_55ml,s5_55ml,s6_55ml,s7_55ml,s8_55ml,s9_55ml,s10_55ml)

PTT_std=[sPTT_10ml,sPTT_15ml,sPTT_20ml,sPTT_25ml,sPTT_30ml,sPTT_35ml,sPTT_40ml,sPTT_45ml,sPTT_50ml]
PTT_volumes=[mPTT_10ml,mPTT_15ml,mPTT_20ml,mPTT_25ml,mPTT_30ml,mPTT_35ml,mPTT_40ml,mPTT_45ml,mPTT_50ml]
volumes=[10,15,20,25,30,35,45,50,55]

diff_amp=extract_data_12May22.extract_data_diffAmp()
M=diff_amp['Voltage_0'][0:10000]
D1=diff_amp['Voltage_1'][0:10000]
D2=diff_amp['Voltage_2'][0:10000]
l=10000
fs=1000
t= np.arange(0, l/fs, 1/fs)
figure(figsize=(10,5))
plot(t,D1, 'g', linewidth=1.75,label='diff amp 1')
plot(t,D2, 'b', linewidth=1.75,label='diff amp 2')
plot(t,M, 'r', linewidth=1.75,label='TTL signal')
xlabel('time (sec)') 
ylabel('Voltage (V)')
legend()
title("Difference amplifiers circuits")
grid(True)
show()
