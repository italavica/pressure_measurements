...
import extract_data_03May22

s1,s2,s3,s4,s5,s6,s7,s8,s9,s10=extract_data_03May22.extract_data_6V()
...
def PTT_v1(s1,s2,s3,s4,s5,s6,s7,s8,s9,s10):
    ...
    # figure(figsize=(10,5))
    # plot(t,PS1_8, 'g', linewidth=1.75,label='PS1')
    # plot(t,PS1_filtered_8, 'g', linewidth=1.75,label='PS1')
    # plot(loc_PS1_8/fs,PS1_filtered_8[loc_PS1_8], 'r*', linewidth=1.75)
    # plot(t,PS2_filtered_8, 'b', linewidth=1.75,label='PS2')
    # plot(loc_PS2_8/fs,PS2_filtered_8[loc_PS2_8], 'r*', linewidth=1.75)
    # legend()
    ...
    return mPTT,sPTT
print('6 V')
s1_6V,s2_6V,s3_6V,s4_6V,s5_6V,s6_6V,s7_6V,s8_6V,s9_6V,s10_6V=extract_data_03May22.extract_data_6V()
mPTT_6V,sPTT_6V=PTT_v1(s1_6V,s2_6V,s3_6V,s4_6V,s5_6V,s6_6V,s7_6V,s8_6V,s9_6V,s10_6V)
print('7 V')
s1_7V,s2_7V,s3_7V,s4_7V,s5_7V,s6_7V,s7_7V,s8_7V,s9_7V,s10_7V=extract_data_03May22.extract_data_7V()
mPTT_7V,sPTT_7V=PTT_v1(s1_7V,s2_7V,s3_7V,s4_7V,s5_7V,s6_7V,s7_7V,s8_7V,s9_7V,s10_7V)
print('8 V')
s1_8V,s2_8V,s3_8V,s4_8V,s5_8V,s6_8V,s7_8V,s8_8V,s9_8V,s10_8V=extract_data_03May22.extract_data_8V()
mPTT_8V,sPTT_8V=PTT_v1(s1_8V,s2_8V,s3_8V,s4_8V,s5_8V,s6_8V,s7_8V,s8_8V,s9_8V,s10_8V)
print('9 V')
s1_9V,s2_9V,s3_9V,s4_9V,s5_9V,s6_9V,s7_9V,s8_9V,s9_9V,s10_9V=extract_data_03May22.extract_data_9V()
mPTT_9V,sPTT_9V=PTT_v1(s1_9V,s2_9V,s3_9V,s4_9V,s5_9V,s6_9V,s7_9V,s8_9V,s9_9V,s10_9V)
print('10 V')
s1_10V,s2_10V,s3_10V,s4_10V,s5_10V,s6_10V,s7_10V,s8_10V,s9_10V,s10_10V=extract_data_03May22.extract_data_10V()
mPTT_10V,sPTT_10V=PTT_v1(s1_10V,s2_10V,s3_10V,s4_10V,s5_10V,s6_10V,s7_10V,s8_10V,s9_10V,s10_10V)
print('11 V')
s1_11V,s2_11V,s3_11V,s4_11V,s5_11V,s6_11V,s7_11V,s8_11V,s9_11V,s10_11V=extract_data_03May22.extract_data_11V()
mPTT_11V,sPTT_11V=PTT_v1(s1_11V,s2_11V,s3_11V,s4_11V,s5_11V,s6_11V,s7_11V,s8_11V,s9_11V,s10_11V)
print('12 V')
s1_12V,s2_12V,s3_12V,s4_12V,s5_12V,s6_12V,s7_12V,s8_12V,s9_12V,s10_12V=extract_data_03May22.extract_data_12V()
